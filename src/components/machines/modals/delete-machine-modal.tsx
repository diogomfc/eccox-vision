...
import { Trash2, Loader2, Server, User } from "lucide-react";
      ...
      <DialogContent className="sm:max-w-[425px] bg-[#1A1A1E] text-white border-gray-700">
        ...
        <div className="py-4 space-y-4">
          <p className="text-sm text-gray-300">
            Você está prestes a excluir a máquina **"{machine.name}"**. Todos os
            dados e aplicações associados a ela serão permanentemente removidos.
          </p>
